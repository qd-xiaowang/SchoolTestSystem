<template>
	<div>
		...
		<el-table :data="searchResult" style="width: 100%" stripe border highlight-current-row>
			...
			<el-table-column label="课程" prop="course.name" width="200px" align="center">
			</el-table-column>
			...
			<el-table-column label="考试时长" prop="durationStr"  width="110px" align="center">
			</el-table-column>
			<el-table-column label="试卷总分" prop="total"  width="110px" align="center">
			</el-table-column>
			<el-table-column label="试卷题数" prop="number"  width="110px" align="center">
			</el-table-column>
			<el-table-column label="单选题数" prop="singleTopicSelection.length"  width="110px" align="center">
			</el-table-column>
			<el-table-column label="多选题数" prop="multipleChoice.length"  width="110px" align="center">
			</el-table-column>
			<el-table-column label="判断题数" prop="trueFalse.length"  width="110px" align="center">
			</el-table-column>
