<template>
	<div>
		...
		<el-form label-width="120px" ref="form" @submit.native.prevent="save('form')" :model="model" :rules="rules">
			<el-form-item label="选择课程：" prop="course">
				<el-select v-model="model.course" clearable placeholder="请选择课程">
					<el-option v-for="item in courses" :key="item._id" :label="item.name" :value="item._id">
					</el-option>
				</el-select>
			</el-form-item>
			<el-form-item label="试卷标题：" prop="name">
				<el-input placeholder="请输入试卷标题" autofocus v-model="model.name" @input="input" style="width: 300px;">
				</el-input>
			</el-form-item>
			<el-form-item label="考试时间：" prop="time">
				<div class="block">
					<el-date-picker v-model="model.time" value-format="timestamp" type="datetimerange"
						range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
					</el-date-picker>
				</div>
			</el-form-item>
			<el-form-item label="考试时长：" prop="duration">
				<el-time-picker v-model="model.duration" placeholder="考试时长" value-format="timestamp">
				</el-time-picker>
			</el-form-item>
<!-- 			<el-form-item>
				<template>
				...
				<template>
					<el-checkbox v-model="model.isOptionsRandon">选项随机排序</el-checkbox>
				</template>
			</el-form-item> -->
<!-- 			<el-form-item>
				<template>
...
<!-- 			<el-form-item>
			...
			<el-form-item label="重复次数：" v-if="model.isRepetition">
				<el-input placeholder="重复次数：" v-model.number="model.repetition" type="number" min="0"
					style="width: 100px"></el-input>
			</el-form-item>

			<el-tabs type="border-card" v-if="isShow">
				<el-tab-pane label="单选题">
					<single-topic-selection :singleTopicSelection="model.singleTopicSelection" />
				</el-tab-pane>
